...
/**
 * A {@link ListAdapter} which wraps a {@link StickyHeadAdapter} and
 * automatically handles wrapping the result of
 * {@link StickyHeadAdapter#getView(int, android.view.View, android.view.ViewGroup)}
 * and
 * {@link StickyHeadAdapter#getHeaderView(int, android.view.View, android.view.ViewGroup)}
 * appropriately.
 * 
 * @author Jake Wharton (jakewharton@gmail.com)
 */
class AdapterWrapper extends BaseAdapter implements StickyHeadAdapter {

    interface OnHeaderClickListener {
        void onHeaderClick(View header, int itemPosition, String headerId);
    }

    final StickyHeadAdapter mDelegate;
    ...
    AdapterWrapper(Context context, StickyHeadAdapter delegate) {
